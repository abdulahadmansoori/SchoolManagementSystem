                        ...
                        <div class="col-md-12">
                            <form action="employee.php" method="POST">
                                <div class="detailsCard">
                                    <h6>Faculty Registration Form</h6>
                                </div>
                                <!-- student details -->
                                <div class="detailsCard">
                                    <span>Details</span>
                                ...
                                <div class="detailsCard">
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            <input class="form-control" type="number" name="education01_year">
                                        </div>
                                        <div class="col-sm-4">
                                ...
                                <div class="mb-3 d-flex justify-content-end mx-4">
                                    ...
                                    <button class="btn bg-warning text-white ms-2 fw-bolder" id="" type="submit">Registerty" type="submit">Register</button>
                                </div>
                            </form>
                        </div>
                    </div>
