...
<body>
            ...
            <div class="row">
                ...
                <div class="col-lg-10 Main-Content overflow-auto">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="m-4">
                                <h6 class="d-inline"><a href="http://localhost/SMS/staffs.php" class="text-black"><i class="bi bi-arrow-left-square-fill"></i></a> Update Staff Information</h6>
                            ...
                            <form action="" method="POST" onsubmit="event.preventDefault();">
                                ...
                                <div class="mb-3 d-flex justify-content-end mx-4">
                                    ...
                                    <button class="btn bg-warning text-white ms-2 fw-bolder" id="update_staff"
    ...
    <script src="./script/update_staff.js" defer></script>
