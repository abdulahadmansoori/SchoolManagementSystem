        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-10 px-3 Main-Content overflow-auto" id="Main-Content">
                    ...
                    <div class="row px-3">
                        <h6 class="my-1"> <a href="http://localhost/SMS/faculties.php" class="text-black"><i class="bi bi-arrow-left-square-fill"></i></a> Faculty <a href="http://localhost/SMS/update_faculty_info.php?id=<?php echo $_GET['id'] ?>" class="text-black"><i class="bi bi-pencil-square"></i></a> Update</h6>
                        <div>
                            ...
                            <a href="http://localhost/SMS/faculties.php" class="text-black"><i class="bi bi-arrow-left-square-fill"> </i>  Back</a>
                        </div>
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.2.2/dist/js/bootstrap.bundle.min.js"
    ...
    <script src="./script/view_faculty.js"></script>
