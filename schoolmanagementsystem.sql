...
(14, 'faizan', 'rashid', '2023-01-05', 'male', '', '', '0000-00-00', '', 'Muslim', '', '', '', '', '', '', '', '', '', '', '', 0, '', '', 0, '', '', 0, '', '', 0, '', '');
...
INSERT INTO `faculty_attendance` (`id`, `fac_id`, `date`, `status`) VALUES
(1, 8, '2023-01-02', 'A'),
(2, 8, '2023-01-03', 'P'),
(3, 8, '2023-01-04', 'L'),
(4, 8, '2023-01-05', 'L'),
...
(65, 'faizan', 'rashid', '2023-01-05', '', 'male', '', '', '', '', 'Muslim', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 2, 2);
...
INSERT INTO `time_table` (`id`, `class_id`, `sec_id`, `period_id`, `fac_id`, `day_id`, `sub_id`) VALUES
(1, 1, 1, 1, 8, 5, 3),
(2, 1, 1, 2, 10, 5, 3);
...
ALTER TABLE `time_table`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `class_id` (`class_id`,`sec_id`,`period_id`,`fac_id`,`day_id`,`sub_id`),
  ADD KEY `sec_id` (`sec_id`),
...
--
ALTER TABLE `faculty_attendance`
  ADD CONSTRAINT `faculty_attendance_ibfk_1` FOREIGN KEY (`fac_id`) REFERENCES `faculty` (`id`);
...
ALTER TABLE `time_table`
  ...
  ADD CONSTRAINT `time_table_ibfk_3` FOREIGN KEY (`sub_id`) REFERENCES `subject` (`id`),
  ADD CONSTRAINT `time_table_ibfk_4` FOREIGN KEY (`day_id`) REFERENCES `days` (`id`),
  ADD CONSTRAINT `time_table_ibfk_5` FOREIGN KEY (`period_id`) REFERENCES `periods` (`id`),
  ADD CONSTRAINT `time_table_ibfk_6` FOREIGN KEY (`fac_id`) REFERENCES `faculty` (`id`);
COMMIT;
